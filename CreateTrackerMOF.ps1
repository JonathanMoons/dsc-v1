...
.DESCRIPTION
    ...
    The script imports the configuration definition from TRMOFIssueNew.ps1, prompts for any required parameters,
...
$configPath = Join-Path $scriptRoot 'TRMOFIssueNew.ps1'
