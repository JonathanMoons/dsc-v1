...
$moduleRequirements = @(
    @{ Name = 'PSDscResources'; RequiredVersion = [Version]'2.12.0.0'; Scope = 'CurrentUser'; Purpose = 'compile ContosoSqlLogin' }
)
...
Write-Host "Compiling ContosoSqlLogin..." -ForegroundColor Cyan
ContosoSqlLogin -SQLServiceUsername $SQLServiceUsername -NodeName $NodeName -OutputPath $outFolder
